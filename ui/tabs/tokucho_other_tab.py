...
from workers.tokucho_other_batch_worker import (
    TokuchoOtherBatchWorker,
)
...
class TokuchoOtherTab(QWidget):
    ...
    def __init__(
        ...
        self.batch_worker: TokuchoOtherBatchWorker | None = None
    ...
    def setup_ui(self) -> None:
        ...
        self.result_table.setMinimumHeight(
            250
        )
    ...
    def start_batch_worker(
        ...
        self.batch_worker = TokuchoOtherBatchWorker(
            pdf_files=pdf_files,
            share_url=share_url,
            user_master_url=user_master_url,
            output_folder=output_folder,
