...
class MsrLedgerWriter:
    ...
    def write(
        ...
        try:
            ...
            sheet = ledger_book.sheets[
                self.SHEET_NAME
            ]

            target_row = self._find_empty_row(
                sheet
            )
            ...
            sheet.range(
                f"C{target_row}"
            ).value = request.department_upper
    ...
    def _find_empty_row(
        ...
        for row_number in range(
            ...
            department = sheet.range(
                f"C{row_number}"
            ).value

            project_name = sheet.range(
                f"G{row_number}"
            ).value
